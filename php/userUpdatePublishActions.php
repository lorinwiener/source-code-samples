...
//  Confidential
//
//  userUpdatePublishActions.php
//
//  © Liquid Entertainment
//
//  Description:
//   updates a user's Facebook publish_action permissions.
//_________________________________________________________________________________________________
//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 ...
 * @param int - $param_publish_actions
 */
...
$param_publish_actions = $_GET['publish_actions'];

function userUpdatePublishActions($arg_user_id, $arg_publish_actions) {
	...
	$success = $user_dao->setPublishActionsByID($user->user_id, $arg_publish_actions);
	// Clear a lock
	if(!$success){
...
userUpdatePublishActions($param_user_id, $param_publish_actions);
